   ...
   ngOnInit()
    ...
    _submit(){
        if(this.excelType==""){
            ...
            this.http.post(this.commonService.getReportServerPath()+"/file/uploadFile/"+this.excelType+"/"+this.cities+"/"+this.asset+"/"+this.period+"/"+this.cookieService.get('credentials'), this.formData, {headers:headers}).toPromise().then(
                res => {
